...
$images_path = (isset($_POST['images_path'])) ? '../'.$_POST['images_path'] : "images/";  //replace this with the path where your images are stored, relative to the directory this script will run from
...
//$thumb = "thumb-" . implode('.',$filename) . '.' . $extension;
